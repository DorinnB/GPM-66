...
$(document).ready(function() {
  ...
  editor = new $.fn.dataTable.Editor( {
    ...
    fields: [
      ...
      {       label: 'val_1',       name: 'eprouvettes.val_1'     },
      {       label: 'val_2',       name: 'eprouvettes.val_2'     },
      {       label: 'val_3',       name: 'eprouvettes.val_3'     },
      {       label: 'val_4',       name: 'eprouvettes.val_4'     },
      {       label: 'val_5',       name: 'eprouvettes.val_5'     },
      {       label: 'val_6',       name: 'eprouvettes.val_6'     },
