...
$(document).ready(function() {
  ...
  editor = new $.fn.dataTable.Editor( {
    ...
    fields: [
      ...
      {       label: 'Rampe 1',       name: 'eprouvettes.c_type_2_val'     },
      {       label: 'Consigne 2',       name: 'eprouvettes.c_type_3_val'     },
      {       label: 'Rampe 2',       name: 'eprouvettes.c_type_4_val'     },
      {       label: 'Runout (s)',       name: 'eprouvettes.runout'     },
      {       label: 'Estimated Duration (s)',       name: 'eprouvettes.cycle_estime'     },
      ...
      {       label: 'Final Duration (s)',       name: 'eprouvettes.Cycle_final'     },
