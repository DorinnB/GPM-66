<div class="row">
  ...
  <div class="col-md-12 machine" style="border:1px solid black; margin:1px 0px;background-color:<?= $poste[$n_poste]['background-color'] ?>;color:<?= $poste[$n_poste]['color'] ?>;display:<?=  ($poste[$n_poste]['currentBlock']=='Send' or $poste[$n_poste]['currentBlock']=='send')?'none':'block'  ?>;">
