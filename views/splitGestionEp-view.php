...
<div class="modal-dialog">
  ...
  <div class="modal-content">
    <div class="modal-header" style="height:15%;">
      <h2 class="modal-title" style="text-align: center;">Specimen :&nbsp;<?= (($eprouvette['prefixe']=="")?"": $eprouvette['prefixe'].' - ').$eprouvette['nom_eprouvette']  ?></h4>
      </div>
              ...
              <div class="tab-content clearfix" style="height:100%;">
                ...
                <div class="tab-pane" id="1a" style="height:100%;">
                  <h3 style="height:100%;">
                    <form class="form-group" style="height:100%;" id="newTestForm">
                      ...
                      <div style="height:25%;">
                        <?php if ($eprouvette['c_checked']==0) :  ?>
                          <p style="color:red; padding-top:10px;">Consigne Unchecked !</p>
                ...
                <div class="tab-pane" id="1e" style="height:100%;">
                  ...
                  <form class="form-group" style="height:100%;" id="update_d_commentaire">
                    ...
                    <div id="save_d_commentaire" style="height:10%; width:10%; background-color:#5B9BD5; float:right;cursor:pointer;">
