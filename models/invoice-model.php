...
class InvoiceModel
{
  ...
  public function getAllInvoiceList($id_tbljob="null") {
    ...
    if ($id_tbljob=="null") {
      $req='SELECT pricinglists.id_pricingList, pricingList, pricingListFR, prodCode, OpnCode, USD, EURO, pricingList_actif, id_test_type
      FROM `pricinglists`
      ...
      $req='SELECT pricinglists.id_pricingList, pricingList, pricingListFR, prodCode, OpnCode, USD, EURO, pricingList_actif
      FROM `tbljobs`
