...
->fields(
  ...
  Field::inst( 'eprouvettes.eprouvette_inOut_A' )->set( Field::SET_EDIT ),
  Field::inst( 'eprouvettes.eprouvette_inOut_B' )->set( Field::SET_EDIT ),
  Field::inst( 'annexe_iqc.date_IQC' )->set( Field::SET_EDIT ),
  Field::inst( 'annexe_iqc.id_tech' )->set( Field::SET_EDIT )
  ...
  //enregistrement de la date de l'opération
    ->on( 'preEdit', function ( $editor, $values ) {
      $editor
      ->field( 'eprouvettes.eprouvette_inOut_A' )
      ->setValue( date('Y-m-d H:i:s') );
    } )
    ->on( 'preEdit', function ( $editor, $values ) {
      $editor
      ->field( 'eprouvettes.eprouvette_inOut_B' )
      ->setValue( date('Y-m-d H:i:s') );
    } )
    ->on( 'preEdit', function ( $editor, $values ) {
      $editor
      ->field( 'annexe_iqc.date_IQC' )
      ->setValue( date('Y-m-d H:i:s') );
    } )
