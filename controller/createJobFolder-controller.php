...
$dir_source = '//SRV-DC01/data/job/#TEMPLATE';
$dir_dest = '//SRV-DC01/data/job/'.$_POST['ref_customer'].'/'.$_POST['ref_customer'].'-'.$_POST['job'];
$dir_dest_customer = '//SRV-DC01/data/job/'.$_POST['ref_customer'];
